...
/**
 * Domain specific class of <code>string_data</code>.
 */ 
public class string_data extends data_value
{
	// meta information
	public static final String META_TYPE = "string_data";
	 ...
	 */ 
	protected string_data(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>string_data</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static string_data create(Container parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new string_data(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
