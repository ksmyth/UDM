...
/**
 * Domain specific class of <code>real_data</code>.
 */ 
public class real_data extends data_value
{
	// meta information
	public static final String META_TYPE = "real_data";
	 ...
	 */ 
	protected real_data(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>real_data</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static real_data create(Container parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new real_data(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
