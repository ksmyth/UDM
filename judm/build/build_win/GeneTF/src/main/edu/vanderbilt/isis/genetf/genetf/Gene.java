...
public class Gene extends UdmPseudoObject
{
	...
	public void settf(Regulation[] a)
		throws UdmException
	{
		setAssociation("tf", new UdmPseudoObjectContainer(a), UdmHelper.CLASS_FROM_TARGET);
	}
	...
	public Regulation[] gettf()
		throws UdmException
	{
		UdmPseudoObjectContainer objs = getAssociation("tf", UdmHelper.CLASS_FROM_TARGET);
