...
public class ContainerFileFactory
{
	...
	private static final String xmlMetaFile ="GeneTRE_udm.xml";
	private static final String xsdMetaFile ="GeneTRE_genetre.xsd";
	private static final String metaName ="GeneTRE";
		 ...
		 throws UdmException 
	{
		factory = new UdmFileFactory(xmlMetaFile, xsdMetaFile, metaName, packagePath){
			protected void loadDiagram() throws UdmException {
				metaDiagram =
					new Diagram(
						xmlMetaFile, edu.vanderbilt.isis.meta.GeneTRE_udm_xml.getString());
			}
		};
	...
	private void initializeMetaClasses() 
		 throws UdmException 
	{
		factory.getDiagram().getMetaClass(TRE.META_TYPE, TRE.META_TYPE_NS);
		factory.getDiagram().getMetaClass(TF.META_TYPE, TF.META_TYPE_NS);
		factory.getDiagram().getMetaClass(PWM.META_TYPE, PWM.META_TYPE_NS);
		...
		// load XSDs
		UdmHelper.StoreXsd("GeneTRE.xsd", edu.vanderbilt.isis.meta.GeneTRE_xsd.getString());
		UdmHelper.StoreXsd("GeneTRE_genetre.xsd", edu.vanderbilt.isis.meta.GeneTRE_genetre_xsd.getString());
	}
