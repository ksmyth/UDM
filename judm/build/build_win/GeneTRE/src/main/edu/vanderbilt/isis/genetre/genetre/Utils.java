...
/**
 * Utility class for namespace <code>genetre</code>.
 */ 
public class Utils
{
	/**
		 ...
		 throws UdmException
	{
		...
		if (TRE.META_TYPE.equals(type))
		{
			return new TRE(obj, diagram);
		}
		else
		if (TF.META_TYPE.equals(type))
		{
			return new TF(obj, diagram);
		}
		else
		if (PWM.META_TYPE.equals(type))
		{
			return new PWM(obj, diagram);
		}
		else
		if (Gene.META_TYPE.equals(type))
		{
			return new Gene(obj, diagram);
		}
		else
