...
/**
 * Domain specific class of <code>PWM</code>.
 */ 
public class PWM extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "PWM";
	 ...
	 */ 
	protected PWM(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>PWM</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static PWM create(Container parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new PWM(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
	...
	public void settf(TF[] a)
		throws UdmException
	{
		setAssociation("tf", new UdmPseudoObjectContainer(a), UdmHelper.TARGET_FROM_PEER);
	}

	/**
	 * Returns the other ends of the association with role name <code>tf</code>.
	...
	public TF[] gettf()
		throws UdmException
	{
		UdmPseudoObjectContainer objs = getAssociation("tf", UdmHelper.TARGET_FROM_PEER);
		return (TF[]) Utils.wrapWithSubclass(objs, TF.class, getDiagram());
	}
