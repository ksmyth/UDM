...
/**
 * Domain specific class of <code>acc</code>.
 */ 
public class acc extends edu.vanderbilt.isis.sbml2ex.sbml.AnnotationType
{
	// meta information
	public static final String META_TYPE = "acc";
	 ...
	 */ 
	protected acc(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>acc</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static acc create(edu.vanderbilt.isis.sbml2ex.sbml.annotation parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new acc(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
