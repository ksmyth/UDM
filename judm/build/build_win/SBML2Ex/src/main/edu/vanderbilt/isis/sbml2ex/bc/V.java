...
/**
 * Domain specific class of <code>V</code>.
 */ 
public class V extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "V";
	 ...
	 */ 
	protected V(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>V</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static V create(EffectorRepressorLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new V(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
	 ...
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static V create(HillLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new V(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
