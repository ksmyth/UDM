...
/**
 * Domain specific class of <code>functionDefinition</code>.
 */ 
public class functionDefinition extends IdBase
{
	// meta information
	public static final String META_TYPE = "functionDefinition";
	 ...
	 */ 
	protected functionDefinition(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>functionDefinition</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static functionDefinition create(listOfFunctionDefinitions parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new functionDefinition(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
