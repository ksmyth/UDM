...
/**
 * Domain specific class of <code>Kcat</code>.
 */ 
public class Kcat extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "Kcat";
	 ...
	 */ 
	protected Kcat(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>Kcat</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static Kcat create(MichaelisMentenLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new Kcat(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
