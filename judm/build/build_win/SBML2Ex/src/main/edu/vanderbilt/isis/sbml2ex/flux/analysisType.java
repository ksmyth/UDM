...
/**
 * Domain specific class of <code>analysisType</code>.
 */ 
public class analysisType extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "analysisType";
	 ...
	 */ 
	protected analysisType(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>analysisType</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static analysisType create(listOfAnalysisTypes parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new analysisType(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
