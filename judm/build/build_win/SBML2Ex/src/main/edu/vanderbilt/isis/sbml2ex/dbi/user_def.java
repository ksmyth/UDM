...
package edu.vanderbilt.isis.sbml2ex.dbi;

import edu.vanderbilt.isis.udm.*;

/**
 * Domain specific class of <code>user_def</code>.
 */ 
public class user_def extends edu.vanderbilt.isis.sbml2ex.sbml.AnnotationType
{
	// meta information
	public static final String META_TYPE = "user_def";
	public static final String META_TYPE_NS = "dbi";
	 ...
	 */ 
	protected user_def(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>user_def</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static user_def create(edu.vanderbilt.isis.sbml2ex.sbml.annotation parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new user_def(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
