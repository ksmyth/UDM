...
/**
 * Domain specific class of <code>ci</code>.
 */ 
public class ci extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "ci";
	 ...
	 */ 
	protected ci(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>ci</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static ci create(Tokens parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new ci(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
