 ...
 * </pre></blockquote>
 */ 
public class sbmlStringFactory
{
	...
	/**
	 * Creates a new data network with root object of type <code>sbml</code> in a string.
		 ...
		 throws UdmException
	{
		sbml root =
			new sbml(
				factory.createNewDataNetwork(sbml.META_TYPE, sbml.META_TYPE_NS)
				, factory.getDiagram());
		return root;
	}
	 ...
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public sbml open(String xmlString) 
		 throws UdmException
	{
		sbml root = 
			new sbml(
