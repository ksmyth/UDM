...
/**
 * Domain specific class of <code>ratelaw</code>.
 */ 
public class ratelaw extends equationBase
{
	// meta information
	public static final String META_TYPE = "ratelaw";
	 ...
	 */ 
	protected ratelaw(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>ratelaw</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static ratelaw create(edu.vanderbilt.isis.sbml2ex.sbml.annotation parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new ratelaw(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
