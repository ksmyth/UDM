...
/**
 * Domain specific class of <code>Kms</code>.
 */ 
public class Kms extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "Kms";
	 ...
	 */ 
	protected Kms(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>Kms</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static Kms create(MichaelisMentenReversibleLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new Kms(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
