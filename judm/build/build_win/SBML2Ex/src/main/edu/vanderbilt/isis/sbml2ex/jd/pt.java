...
/**
 * Domain specific class of <code>pt</code>.
 */ 
public class pt extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "pt";
	 ...
	 */ 
	protected pt(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>pt</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static pt create(arcSeg parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new pt(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
