...
/**
 * Domain specific class of <code>Vb</code>.
 */ 
public class Vb extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "Vb";
	 ...
	 */ 
	protected Vb(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>Vb</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static Vb create(MichaelisMentenReversibleLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new Vb(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
