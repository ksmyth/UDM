...
/**
 * Domain specific class of <code>S_Half</code>.
 */ 
public class S_Half extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "S_Half";
	 ...
	 */ 
	protected S_Half(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>S_Half</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static S_Half create(HillLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new S_Half(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
