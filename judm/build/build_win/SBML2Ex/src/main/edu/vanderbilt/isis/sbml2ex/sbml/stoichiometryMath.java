...
/**
 * Domain specific class of <code>stoichiometryMath</code>.
 */ 
public class stoichiometryMath extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "stoichiometryMath";
	 ...
	 */ 
	protected stoichiometryMath(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>stoichiometryMath</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static stoichiometryMath create(speciesReference parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new stoichiometryMath(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
