...
/**
 * Domain specific class of <code>Km</code>.
 */ 
public class Km extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "Km";
	 ...
	 */ 
	protected Km(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>Km</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static Km create(MichaelisMentenLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new Km(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
