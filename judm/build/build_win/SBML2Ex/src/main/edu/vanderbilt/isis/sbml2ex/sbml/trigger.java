...
/**
 * Domain specific class of <code>trigger</code>.
 */ 
public class trigger extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "trigger";
	 ...
	 */ 
	protected trigger(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>trigger</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static trigger create(event parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new trigger(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
