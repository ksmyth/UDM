...
/**
 * Domain specific class of <code>B</code>.
 */ 
public class B extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "B";
	 ...
	 */ 
	protected B(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>B</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static B create(EffectorRepressorLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new B(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
