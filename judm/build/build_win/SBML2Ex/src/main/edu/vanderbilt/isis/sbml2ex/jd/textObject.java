...
/**
 * Domain specific class of <code>textObject</code>.
 */ 
public class textObject extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "textObject";
	 ...
	 */ 
	protected textObject(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>textObject</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static textObject create(otherDisplayObjects parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new textObject(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
