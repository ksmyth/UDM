 ...
 *        simpleSpeciesReferenceStringFactory gtf = FactoryRepository.getsbmlsimpleSpeciesReferenceStringFactory();
 *        simpleSpeciesReference root = gtf.open(xmlString);
 * 
 ...
 * </pre></blockquote>
 */ 
public class simpleSpeciesReferenceStringFactory
{
	 ...
	 */ 
	public simpleSpeciesReferenceStringFactory()
		 throws UdmException 
	{
	...
	/**
	 * Creates a new data network with root object of type <code>simpleSpeciesReference</code> in a string.
	 * @return  The root object of the data network
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public simpleSpeciesReference create()
		 throws UdmException
	{
		simpleSpeciesReference root =
			new simpleSpeciesReference(
				factory.createNewDataNetwork(simpleSpeciesReference.META_TYPE, simpleSpeciesReference.META_TYPE_NS)
				, factory.getDiagram());
		return root;
	}
	 ...
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public simpleSpeciesReference open(String xmlString) 
		 throws UdmException
	{
		simpleSpeciesReference root = 
			new simpleSpeciesReference(
