...
/**
 * Domain specific class of <code>Vf</code>.
 */ 
public class Vf extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "Vf";
	 ...
	 */ 
	protected Vf(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>Vf</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static Vf create(MichaelisMentenReversibleLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new Vf(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
