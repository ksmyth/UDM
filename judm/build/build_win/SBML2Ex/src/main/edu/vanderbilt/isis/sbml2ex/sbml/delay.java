...
/**
 * Domain specific class of <code>delay</code>.
 */ 
public class delay extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "delay";
	 ...
	 */ 
	protected delay(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>delay</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static delay create(event parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new delay(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
