...
/**
 * Domain specific class of <code>Rtot</code>.
 */ 
public class Rtot extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "Rtot";
	 ...
	 */ 
	protected Rtot(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>Rtot</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static Rtot create(EffectorRepressorLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new Rtot(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
