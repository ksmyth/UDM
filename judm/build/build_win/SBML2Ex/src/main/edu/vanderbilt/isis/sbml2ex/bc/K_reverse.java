...
/**
 * Domain specific class of <code>K_reverse</code>.
 */ 
public class K_reverse extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "K_reverse";
	 ...
	 */ 
	protected K_reverse(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>K_reverse</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static K_reverse create(MassActionLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new K_reverse(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
