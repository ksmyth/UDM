...
/**
 * Domain specific class of <code>rule</code>.
 */ 
public class rule extends SBase
{
	// meta information
	public static final String META_TYPE = "rule";
	 ...
	 */ 
	protected rule(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
		...
		throws UdmException 
	{
		...
		return new rule(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
