...
/**
 * Utility class for namespace <code>jd</code>.
 */ 
public class Utils
{
	/**
		 ...
		 throws UdmException
	{
		...
		if (SBMLGraphicsHeader.META_TYPE.equals(type))
		{
			return new SBMLGraphicsHeader(obj, diagram);
		}
		else
		if (boundingBox.META_TYPE.equals(type))
		{
			return new boundingBox(obj, diagram);
		}
		else
		if (textObject.META_TYPE.equals(type))
		{
			return new textObject(obj, diagram);
		}
		else
		if (otherDisplayObjects.META_TYPE.equals(type))
		{
			return new otherDisplayObjects(obj, diagram);
		}
		else
		if (pt.META_TYPE.equals(type))
		{
			return new pt(obj, diagram);
		}
		else
		if (arcSeg.META_TYPE.equals(type))
		{
			return new arcSeg(obj, diagram);
		}
		else
		if (font.META_TYPE.equals(type))
		{
			return new font(obj, diagram);
		}
		else
		if (display.META_TYPE.equals(type))
		{
			return new display(obj, diagram);
		}
		else
		{
