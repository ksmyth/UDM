...
/**
 * Domain specific factory class for <code>sbml</code>.
 ...
 * where the type of the root object is <code>sbml</code>.
 * <blockquote><pre>
 *         ....;
 *        // open the data network
 *        sbmlFileFactory gtf = FactoryRepository.getsbmlsbmlFileFactory();
 *        sbml root = gtf.open("sbml-existingmodel.xml");
 * 
...
public class sbmlFileFactory
{
	...
	/**
	 * Creates a new data network with root object of type <code>sbml</code> in the file specified by the parameter.
	 * @param  instanceFileName The name of the instance file
	 * @return  The root object of the data network
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public sbml create(String instanceFileName) 
		 throws UdmException
	{
		sbml root =
			new sbml(
				factory.createNewDataNetwork(instanceFileName, sbml.META_TYPE, sbml.META_TYPE_NS),
				factory.getDiagram());
		return root;
	}
	 ...
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public sbml open(String instanceFileName) 
		 throws UdmException
	{
		sbml root = 
			new sbml(
	 ...
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public sbml open(InputStream xmlStream) 
		 throws UdmException
	{
		sbml root = 
			new sbml(
