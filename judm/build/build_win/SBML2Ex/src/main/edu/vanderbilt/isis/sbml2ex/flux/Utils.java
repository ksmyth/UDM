...
/**
 * Utility class for namespace <code>flux</code>.
 */ 
public class Utils
{
	/**
		 ...
		 throws UdmException
	{
		...
		if (limit.META_TYPE.equals(type))
		{
			return new limit(obj, diagram);
		}
		else
		if (analysis.META_TYPE.equals(type))
		{
			return new analysis(obj, diagram);
		}
		else
		if (analysisType.META_TYPE.equals(type))
		{
			return new analysisType(obj, diagram);
		}
		else
		if (listOfAnalyses.META_TYPE.equals(type))
		{
			return new listOfAnalyses(obj, diagram);
		}
		else
		if (listOfAnalysisTypes.META_TYPE.equals(type))
		{
			return new listOfAnalysisTypes(obj, diagram);
		}
		else
		{
