...
/**
 * Domain specific class of <code>cn</code>.
 */ 
public class cn extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "cn";
	 ...
	 */ 
	protected cn(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>cn</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static cn create(Tokens parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new cn(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
