...
/**
 * Utility class for namespace <code>unigene</code>.
 */ 
public class Utils
{
	/**
		 ...
		 throws UdmException
	{
		...
		if (cluster_id.META_TYPE.equals(type))
		{
			return new cluster_id(obj, diagram);
		}
		else
		...
		if (acc.META_TYPE.equals(type))
		{
			return new acc(obj, diagram);
		}
		else
		{
