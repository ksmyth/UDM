...
/**
 * Domain specific class of <code>K</code>.
 */ 
public class K extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "K";
	 ...
	 */ 
	protected K(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>K</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static K create(ConstantLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new K(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
