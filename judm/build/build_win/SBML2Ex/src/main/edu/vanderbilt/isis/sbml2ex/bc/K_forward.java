...
/**
 * Domain specific class of <code>K_forward</code>.
 */ 
public class K_forward extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "K_forward";
	 ...
	 */ 
	protected K_forward(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>K_forward</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static K_forward create(MassActionLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new K_forward(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
