...
/**
 * Domain specific class of <code>Kmp</code>.
 */ 
public class Kmp extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "Kmp";
	 ...
	 */ 
	protected Kmp(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>Kmp</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static Kmp create(MichaelisMentenReversibleLaw parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new Kmp(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
