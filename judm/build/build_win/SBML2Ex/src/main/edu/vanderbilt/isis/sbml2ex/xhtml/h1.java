...
/**
 * Domain specific class of <code>h1</code>.
 */ 
public class h1 extends UdmPseudoObject
{
	// meta information
	public static final String META_TYPE = "h1";
	 ...
	 */ 
	protected h1(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>h1</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static h1 create(body_base parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new h1(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
