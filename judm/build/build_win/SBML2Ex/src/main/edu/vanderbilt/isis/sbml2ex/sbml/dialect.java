...
/**
 * Domain specific class of <code>dialect</code>.
 */ 
public class dialect extends AnnotationType
{
	// meta information
	public static final String META_TYPE = "dialect";
	 ...
	 */ 
	protected dialect(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>dialect</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static dialect create(annotation parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new dialect(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
