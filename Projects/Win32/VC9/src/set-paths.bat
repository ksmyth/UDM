...
set LIB=%UDM_3RDPARTY_PATH%\Xalan-C_1_11_0\lib;%UDM_3RDPARTY_PATH%\xerces-c_2_8_0\lib;%UDM_3RDPARTY_PATH%\zlib;%UDM_3RDPARTY_PATH%\antlr-2.7.7\lib;%UDM_3RDPARTY_PATH%\cppunit-1.12.1\lib;%UDM_3RDPARTY_PATH%\boost_1_36_0\lib;%JDK_PATH%\lib
