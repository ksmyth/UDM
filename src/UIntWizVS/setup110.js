...
// Setup program for the UDM Interpreter Wizard for VC++ 11.0 (Visual Studio 2012)
...
function main()
{
	...
	catch(e)
	{
		...
		catch(e)
		{
			try
			{
				var strVCExKey = "HKLM\\Software\\Microsoft\\VCExpress\\11.0\\Setup\\VC\\ProductDir";
				strValue = WSShell.RegRead(strVCExKey);
			}
			catch(e)
			{
				WScript.Echo("Cannot find where Visual Studio 2012 is installed. UdmInterpreter wizard will be unavailable.");
				return;
			}
