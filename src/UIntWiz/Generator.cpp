...
bool CGenerator::GenerateProjectFile()
{
	...
	*/
	//Added by Ananth
	fprintf(fDspFile,"# ADD LINK32 xerces-c_2D.lib ZlibD.lib UdmBase_D.lib UdmDom_D.lib UdmUtil_D.lib UdmGme_D.lib /nologo /subsystem:windows /dll /debug /machine:I386 /pdbtype:sept /libpath:\"%s\\lib\" /libpath:\"%s\\3rdParty\\zlib\" /libpath:\"%s\\3rdParty\\xerces\\xerces-c2_2_0-win32\\lib\"\n",m_UdmData.m_strUdmPath,m_UdmData.m_strUdmPath,m_UdmData.m_strUdmPath);
	...
	*/
	//Added by Ananth
	fprintf(fDspFile,"# ADD BASE LINK32 xerces-c_2.lib Zlib.lib /nologo /subsystem:windows /dll /machine:I386 /out:\"Release/Component.dll\" /libpath:\"%s\\3rdParty\\zlib\" /libpath:\"%s\\3rdParty\\xerces\\xerces-c2_2_0-win32\\lib\"\n",m_UdmData.m_strUdmPath,m_UdmData.m_strUdmPath);
	fprintf(fDspFile,"# ADD LINK32 xerces-c_2.lib Zlib.lib UdmBase.lib UdmDom.lib UdmUtil.lib UdmGme.lib /nologo /subsystem:windows /dll /machine:I386 /libpath:\"%s\\lib\" /libpath:\"%s\\3rdParty\\zlib\" /libpath:\"%s\\3rdParty\\xerces\\xerces-c2_2_0-win32\\lib\"\n",m_UdmData.m_strUdmPath,m_UdmData.m_strUdmPath,m_UdmData.m_strUdmPath);
	//end
	fprintf(fDspFile,"# Begin Custom Build - Performing registration\n");
	...
	*/
	...
	fprintf(fDspFile,"LINK32=link.exe\n");
	fprintf(fDspFile,"# ADD BASE LINK32 /nologo /subsystem:windows /dll /machine:I386\n");
	fprintf(fDspFile,"# ADD LINK32 xerces-c_2.lib zlib.lib UdmBase.lib UdmGme.lib UdmUtil.lib UdmDom.lib /nologo /subsystem:windows /dll /machine:I386 /libpath:\"%s\\Lib,%s\\3rdParty\\xerces\\xerces-c2_2_0-win32\\lib,%s\\3rdparty\\zlib\"\n",m_UdmData.m_strUdmPath,m_UdmData.m_strUdmPath,m_UdmData.m_strUdmPath);
	/*Commented by Ananth
