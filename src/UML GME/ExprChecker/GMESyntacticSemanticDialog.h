...
private :
	...
	OCLUML::ConstraintVector			m_vecConstraints;
	OCLUML::ConstraintDefVector			m_vecConstraintDefinitions;
	int										m_iSelected;
	int										m_iSelectedError;

public :
	void AddItem( const OCLUML::SpConstraint& item );
	void AddItem( const OCLUML::SpConstraintDef& item );
...
protected:
	...
	// Generated message GOCL_STL_NS()map functions
