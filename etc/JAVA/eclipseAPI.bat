...
%UDM_PATH%\judm\lib\ant-1.6.2\bin\ant -f %UDM_PATH%\etc\java\etc\build.xml -Dbasedir=%curr_dir% -Ddspackage=%1 -quiet eclipse
echo Done

:usage
echo .
echo eclipseApi: Wrong parameter!
echo Usage:   %%UDM_PATH%%\etc\java\judmAPI [eclipse_project_name] [UML_meta_model] [UDM_parameters]
