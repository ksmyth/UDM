...
zip "%_UDM_PATH%\model-files-%_VC%-%_UDM_BUILD%.zip" samples/CL_udm.udm samples/LampDiagram_udm.xml tests/testGetAdjacentObjects/testAssociationScenarios_udm.udm tests/testOCL/SBML2_udm.xml tests/testUdmCint/GeneTF_udm.xml tests/testUdmCint/SBML2Ex_udm.xml tests/test_assocInheritanceMGA/SignalFlow_udm.xml tests/test_ns/test_ns_udm.xml tests/test_ns2/CHost_udm.xml tests/test_refports/RefPort_udm.xml judm/samples/GeneTF/meta/GeneTF_udm.xml judm/samples/GeneTRE/meta/GeneTRE_udm.xml judm/samples/SBML2Ex/meta/SBML2Ex_udm.xml judm/samples/TimeSeries/meta/TimeSeries_udm.xml || exit /b 3
) else (
