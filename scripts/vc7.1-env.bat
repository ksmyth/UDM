...
if exist %~dp0vc7.1-env-local.bat call %~dp0vc7.1-env-local.bat
...
set PATH=%UDM_3RDPARTY_PATH%\xerces-c_2_5_0\bin;^
...
set INCLUDE=%UDM_3RDPARTY_PATH%\xerces-c_2_5_0\include;^
...
set LIB=%UDM_3RDPARTY_PATH%\Xalan-C_1_8_0\lib;^
...
%UDM_3RDPARTY_PATH%\antlr-2.7.1\antlr.jar
