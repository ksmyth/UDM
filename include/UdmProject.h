	...
	extern  Udm::UdmDiagram diagram;
	 ...
	 void Initialize();
		...
		public:
			...
			Udm::ArchetypeAttr< ::UdmProject::Project> Archetype() { return Udm::ArchetypeAttr< ::UdmProject::Project>(impl);}
		...
		public:
			...
			Udm::ArchetypeAttr< ::UdmProject::Datanetwork> Archetype() { return Udm::ArchetypeAttr< ::UdmProject::Datanetwork>(impl);}
