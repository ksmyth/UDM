...
int main_static(int argc, char * argv[])
{
	try
	{
		...
		*/
		...
		sm1.CreateNew("sm1.xml", "CD1", CD1::CD1::M1::meta);
		sm2.CreateNew("sm2.xml", "CD2", CD2::CD2::M2::meta);
		sm3.CreateNew("sm3.xml", "CD3", CD3::CD3::MM3::meta);

		CD1::CD1::M1 m1 = CD1::CD1::M1::Cast(sm1.GetRootObject());
		CD2::CD2::M2 m2 = CD2::CD2::M2::Cast(sm2.GetRootObject());
		CD3::CD3::MM3 m3 = CD3::CD3::MM3::Cast(sm3.GetRootObject());
	...
	{
		{
			...
			Udm::DataNetworkSpecifier cd1_dn("CD1_inst.xml", "CD1", CD1::CD1::M1::meta);
			Udm::DataNetworkSpecifier cd2_dn("CD2_inst.xml", "CD2", CD2::CD2::M2::meta);
			Udm::DataNetworkSpecifier cd3_dn("CD3_inst.xml", "CD3", CD3::CD3::MM3::meta);
			...
			CD1::CD1::M1 m1 = CD1::CD1::M1::Cast(cd1.GetRootObject());
			CD2::CD2::M2 m2 = CD2::CD2::M2::Cast(cd2.GetRootObject());
			CD3::CD3::MM3 m3 = CD3::CD3::MM3::Cast(cd3.GetRootObject());
			...
			//test
			CD2::CD2::M2 m2_too = m1.src_end();
			if (m2 != m2_too)
				throw udm_exception("Test failed!");

			CD3::CD2::M3 m3_too = m1.dst_end();
			if (m3 != m3_too)
				throw udm_exception("Test failed!");
			...
			*/
			...
			CD1::CD1::M1 m1_too = m2.dst();
			if (m1 != m1_too)
				throw udm_exception("Test failed!");

			set<CD1::CD1::M1> a_too = m3.src();
			...
			set<CD1::CD1::M1, greater_equal<CD1::CD1::M1> > a_tooo = m3.src_sorted(greater_equal<CD1::CD1::M1>());
			
			
/*			
			//simple links
			//setting a cross-network  simple link
			set<CD2::CD2::M2> s; s.insert(m2);
			m1.dst() = s;

			//getting a cross-network simple link
			set<CD2::CD2::M2> ss = m1.dst();
*/			


			set<Uml::AssociationRole> asr = Uml::AncestorCrossAssociationRoles(CD3::CD3::MM3::meta, Uml::GetTheOnlyNamespace(*CL::diagram.dgr));
			cout << asr.size() << endl;
